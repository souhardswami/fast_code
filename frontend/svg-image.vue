<template>
    <div>
                    ...
                    <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                        ...
                        <title>coding</title>
                        <rect id="pop" x="763.63" y="283" width="52" height="27" fill="#6c63ff" opacity="0.2" />
                        <rect id="pop" x="767.63" y="316" width="52" height="27" fill="#6c63ff" opacity="0.2" />
                        <rect id="pop" x="724.63" y="87" width="52" height="27" fill="#6c63ff" opacity="0.2" />
                        <rect id="pop" x="761.63" y="118" width="52" height="27" fill="#6c63ff" opacity="0.2" />
                        <rect id="pop" x="661.63" y="89" width="52" height="27" fill="#6c63ff" opacity="0.2" />
                        <rect id="pop" x="828.63" y="149" width="52" height="27" fill="#6c63ff" opacity="0.2" />
                        <rect id="pop" x="765.63" y="151" width="52" height="27" fill="#6c63ff" opacity="0.2" />
                        <rect id="pop" x="698.63" y="120" width="52" height="27" fill="#6c63ff" opacity="0.2" />
                        <rect id="pop" x="825.63" y="357" width="52" height="27" fill="#6c63ff" opacity="0.2" />
                        <rect id="pop" x="762.63" y="359" width="52" height="27" fill="#6c63ff" opacity="0.2" />
                        <path
                        ...
                        transform="translate(-149.42 -56.5)" fill="#6c63ff" />
                        <path d="M280.17,332.5s41.37,89.84,0,163.12-7.09,279,102.84,308.52" transform="translate(-149.42 -56.5)"
                        ...
                        fill="none" stroke="#535461" stroke-miterlimit="10" stroke-width="2" />
                        <rect id="pop2" x="0.63" y="284" width="52" height="27" fill="#6c63ff" opacity="0.2" />
                        <rect id="pop2" x="37.63" y="315" width="52" height="27" fill="#6c63ff" opacity="0.2" />
                        <rect id="pop2" x="318.63" width="52" height="27" fill="#6c63ff" opacity="0.2" />
                        <rect id="pop" x="728.63" y="498" width="52" height="27" fill="#6c63ff" opacity="0.2" />
                        <rect id="pop2" x="41.63" y="348" width="52" height="27" fill="#6c63ff" opacity="0.2" />
                        <rect id="pop2" x="355.63" y="31" width="52" height="27" fill="#6c63ff" opacity="0.2" />
                        <rect id="pop2" x="165.63" y="214" width="52" height="27" fill="#6c63ff" opacity="0.2" />
                        <rect id="pop2" x="202.63" y="245" width="52" height="27" fill="#6c63ff" opacity="0.2" />
                        <rect id="pop2" x="301.63" y="228" width="52" height="27" fill="#6c63ff" opacity="0.2" />
                        <rect id="pop2" x="206.63" y="278" width="52" height="27" fill="#6c63ff" opacity="0.2" />
                        <rect id="pop" x="798.63" y="498" width="52" height="27" fill="#6c63ff" opacity="0.2" />
                        <path
